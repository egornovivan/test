...
public class UIScrollBox : MonoBehaviour
{
	...
	private void Start()
	{
		...
		if ((bool)m_DraggablePanel)
		{
			...
			m_DraggablePanel.transform.localPosition = new Vector3(0f, 0f, -2f);
		}
	}
	...
	private void Update()
	{
		...
		{
			m_DragContent.center = new Vector3((float)m_Width * 0.5f + 10f - m_DraggablePanel.transform.localPosition.x, (float)(-m_Height) * 0.5f - 10f - m_DraggablePanel.transform.localPosition.y, 0f);
			m_DragContent.size = new Vector3(m_Width, m_Height, 0f);
		}
	}
	...
	public void Reposition()
	{
		...
		{
			m_VertScrollBar.transform.localPosition = new Vector3(m_Width + 25, -20f, 0f);
