...
public class CustomMetaData
{
	...
	{
		int count = mMetaDataList.Count;
		for (int i = 0; i < count; i++)
		{
			string[] array = mMetaDataList[i].mModelPath.Split('-');
			AssetsLoader.Instance.LoadPrefabImm(array[0], bIntoCache: true);
		}
	}
}
