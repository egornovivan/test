...
public class TrainingRoomConfig
{
	...
	{
		private string titleChs = string.Empty;

		private string titleEng = string.Empty;

		private string discribeChs = string.Empty;

		private string discribeEng = string.Empty;

		private string iconname = "SubMission";
	...
	public static int[] IDs = new int[6] { 719, 720, 721, 722, 723, 724 };

	public static TrainingMission[] missions = new TrainingMission[5]
	{
		new TrainingMission("采集训练", "dig train", "装备工具挖掘，直到能打开埋藏的宝箱", "equip the tool and dig until you can get the treasures buried in the soil", "SubMission"),
		new TrainingMission("砍树训练", "felling train", "装备工具砍树，获得材料", "equip the tool and cut the tree down to gather materials", "SubMission"),
		new TrainingMission("训练", "felling train", "装备工具砍树，获得材料", "equip the tool and cut the tree down to gather materials", "SubMission"),
		new TrainingMission("挖掘训练", "dig train", "装备工具挖掘，直到能打开埋藏的宝箱", "equip the tool and dig until you can get the treasures buried in the soil", "SubMission"),
		new TrainingMission("搭建训练", "felling train", "装备工具砍树，获得材料", "equip the tool and cut the tree down to gather materials", "SubMission")
	};
