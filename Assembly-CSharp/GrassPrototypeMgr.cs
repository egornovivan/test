...
public class GrassPrototypeMgr : MonoBehaviour
{
	...
	[SerializeField]
	public List<GrassPrototype> m_Prototypes;
	...
	public void GenerateTextures()
	{
		...
		File.WriteAllBytes("Assets/Scripts/ZhouXun/Grass Billboards/Textures/" + m_DiffuseMapFileName + ".png", array);
		array = m_PropertyMap.EncodeToPNG();
		File.WriteAllBytes("Assets/Scripts/ZhouXun/Grass Billboards/Textures/" + m_PropertyMapFileName + ".png", array);
	}
}
