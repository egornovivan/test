...
public class NaturalRes
{
	...
	public static void LoadData()
	{
		...
		while (sqliteDataReader.Read())
		{
			...
			naturalRes.mGroundEffectID = Convert.ToInt32(sqliteDataReader.GetString(sqliteDataReader.GetOrdinal("ground_effect")));
			naturalRes.mGroundSoundIDs = Db.ReadIntArray(sqliteDataReader.GetString(sqliteDataReader.GetOrdinal("walk_sound")));
			naturalRes.mCastSkill = Convert.ToInt32(sqliteDataReader.GetString(sqliteDataReader.GetOrdinal("gather_skill")));
