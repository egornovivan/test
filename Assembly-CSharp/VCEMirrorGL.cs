...
public class VCEMirrorGL : MonoBehaviour
{
	...
	private void Update()
	{
		...
		m_PlaneX.transform.localPosition = new Vector3(VCEditor.s_Mirror.m_PosX, 0f, 0f) * VCEditor.s_Scene.m_Setting.m_VoxelSize;
		m_PlaneY.transform.localPosition = new Vector3(0f, VCEditor.s_Mirror.m_PosY, 0f) * VCEditor.s_Scene.m_Setting.m_VoxelSize;
		m_PlaneZ.transform.localPosition = new Vector3(0f, 0f, VCEditor.s_Mirror.m_PosZ) * VCEditor.s_Scene.m_Setting.m_VoxelSize;
		m_AxisXY.transform.localPosition = new Vector3(VCEditor.s_Mirror.m_PosX, VCEditor.s_Mirror.m_PosY, 0f) * VCEditor.s_Scene.m_Setting.m_VoxelSize;
		m_AxisYZ.transform.localPosition = new Vector3(0f, VCEditor.s_Mirror.m_PosY, VCEditor.s_Mirror.m_PosZ) * VCEditor.s_Scene.m_Setting.m_VoxelSize;
		m_AxisZX.transform.localPosition = new Vector3(VCEditor.s_Mirror.m_PosX, 0f, VCEditor.s_Mirror.m_PosZ) * VCEditor.s_Scene.m_Setting.m_VoxelSize;
