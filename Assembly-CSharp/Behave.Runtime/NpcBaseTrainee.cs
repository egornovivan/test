...
public class NpcBaseTrainee : BTNormal
{
	...
	{
		LearnTrans = base.WorkEntity.workTrans[index];
		PETrainner pETrainner = base.Trainner as PETrainner;
		if (pETrainner != null)
		{
			mTrainee = pETrainner.Singles[index];
		}
	}
	...
	private BehaveResult Init(Tree sender)
	{
		...
		if (base.NpcTrainerType != ETrainerType.Trainee)
		{
			return BehaveResult.Failure;
		}
		...
		mIndex = (int)(base.NpcTrainingType + 2);
	...
	private BehaveResult Tick(Tree sender)
	{
		...
		{
			return EndOperate(mTrainee, base.Operator);
		}
		if (base.NpcTrainerType != ETrainerType.Trainee)
		{
			return EndOperate(mTrainee, base.Operator);
		}
		if (base.WorkEntity == null || base.WorkEntity.workTrans == null || base.Trainner == null || LearnTrans == null || mTrainee == null)
		{
			return EndOperate(mTrainee, base.Operator);
		}
		...
		if (!mTrainee.ContainsOperator(base.Operator))
		{
			...
			else
			{
				...
				mTrainee.StartOperate(base.Operator, EOperationMask.Practice);
