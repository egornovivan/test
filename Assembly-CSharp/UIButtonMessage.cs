...
public class UIButtonMessage : MonoBehaviour
{
	...
	public MouseButtonTrigger buttonTrigger = MouseButtonTrigger.Both;
	...
	{
		if (base.enabled && ((isPressed && trigger == Trigger.OnPress && CheckMouseButtonPress()) || (!isPressed && trigger == Trigger.OnRelease && CheckMouseButtonRelease())))
		{
			Send();
		}
	}

	private bool CheckMouseButtonPress()
	{
		return true;
	}

	private bool CheckMouseButtonRelease()
	{
		return true;
	}

	private bool CheckMouseButtonClick()
	{
		return true;
	}
	...
	{
		if (base.enabled && trigger == Trigger.OnClick && CheckMouseButtonClick())
		{
			Send();
		}
	}
