...
internal class BattleConstData
{
	...
	internal static void LoadData()
	{
		...
		_scoreInfo = $"\nPlayer Slain:{Instance._points_kill}\nAssist:{Instance._points_assist}\nDig:{Instance._points_dig}\nChop:{Instance._points_fell}\nBuild a Block:{Instance._points_build}\nTerritory Captured:{Instance._points_capture}\nTerritory Hold Per {Instance._site_interval} Seconds:{Instance._points_site}";
		_meatInfo = $"\r\nPlayer Slain:{Instance._meat_kill}\r\nAssist:{Instance._meat_assist}\r\nTerritory Captured:{Instance._meat_site}\r\nTerritory Hold Per {Instance._site_interval} Seconds:{Instance._meat_time}";
	}
}
