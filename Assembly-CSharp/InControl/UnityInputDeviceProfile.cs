...
public class UnityInputDeviceProfile
{
	...
	public bool IsSupportedOnThisPlatform
	{
		get
		{
			...
			foreach (string text in supportedPlatforms)
			{
	...
	public bool IsJoystick => LastResortRegex != null || (JoystickNames != null && JoystickNames.Length > 0) || (JoystickRegex != null && JoystickRegex.Length > 0);

	public bool IsNotJoystick => !IsJoystick;

	public bool IsHidden => hideList.Contains(GetType());
