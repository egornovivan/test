...
public abstract class UIWidget : MonoBehaviour
{
	...
	protected static Vector2[] s_4v20 = new Vector2[4];

	protected static Vector2[] s_4v21 = new Vector2[4];

	protected static Vector2[] s_4v22 = new Vector2[4];

	protected static Vector2[] s_4v23 = new Vector2[4];

	protected static readonly float[] c_matrix = new float[16]
	{
	...
	private UIBaseWidget mBase;

	private UIAlphaGroup[] mGroups;

	public float bufferAlpha = 1f;

	private float lastParentAlpha = 1f;
	...
	public float finalAlpha => alpha * parentAlpha * bufferAlpha;
	...
	private void Start()
	{
		OnStart();
		CreatePanel();
		mBase = GetComponentInParent<UIBaseWidget>();
		mGroups = GetComponentsInParent<UIAlphaGroup>(includeInactive: true);
	}
	...
	public void Update()
	{
		...
		if (lastParentAlpha != parentAlpha)
		{
			mChanged = true;
			lastParentAlpha = parentAlpha;
		}
	}
