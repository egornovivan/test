...
public class UIPopupList : MonoBehaviour
{
	...
	public GameObject ChildPopupMenu => mChild;
	...
	public string selection
	{
		...
		set
		{
			if (mSelectedItem != value)
			{
				...
				if (eventReceiver != null && !string.IsNullOrEmpty(functionName) && !string.IsNullOrEmpty(mSelectedItem) && Application.isPlaying)
				{
