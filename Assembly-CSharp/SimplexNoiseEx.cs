...
public class SimplexNoiseEx
{
	...
	public SimplexNoiseEx()
	{
		InitMember();
	}

	public SimplexNoiseEx(long seed)
	{
		InitMember(seed);
	}
	...
	public double Noise(double xin)
	{
		...
		return (num6 + num8) * 3.1604938271604;
	}
	...
	public double Noise(double xin, double yin)
	{
		...
		return 70.1475 * (num21 + num23 + num25);
	}
	...
	public double Noise(double xin, double yin, double zin)
	{
		...
		return 32.696434 * (num35 + num37 + num39 + num41);
	}
	...
	public double Noise(double x, double y, double z, double w)
	{
		...
		return 27.29 * (num57 + num59 + num61 + num63 + num65);
	}
