...
public class TweenMaterialTextureScale : TweenMaterialProperty
{
	...
	public override void OnTween(float factor)
	{
		...
		{
			_temp = _material.GetTextureScale(base.propertyName);
			if (mask.GetBit(0))
			{
			...
			_material.SetTextureScale(base.propertyName, _temp);
		}
	}
	...
	public override void OnRecord()
	{
		if ((bool)(_material = base.material))
		{
			_original = _material.GetTextureScale(base.propertyName);
		}
	}
	...
	public override void OnRestore()
	{
		if ((bool)(_material = base.material))
		{
			_material.SetTextureScale(base.propertyName, _original);
		}
	}
	...
	public void SetFromToCurrent()
	{
		if ((bool)(_material = base.material))
		{
			from = _material.GetTextureScale(base.propertyName);
		}
	}
	...
	public void SetToToCurrent()
	{
		if ((bool)(_material = base.material))
		{
			to = _material.GetTextureScale(base.propertyName);
		}
	}
	...
	public void SetCurrentToFrom()
	{
		if ((bool)(_material = base.material))
		{
			_material.SetTextureScale(base.propertyName, from);
		}
	}
	...
	public void SetCurrentToTo()
	{
		if ((bool)(_material = base.material))
		{
			_material.SetTextureScale(base.propertyName, to);
		}
	}
}
