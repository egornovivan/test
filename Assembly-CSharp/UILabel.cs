...
public class UILabel : UIWidget
{
	...
	private static string s_strGfxDeviceVersion;
	...
	public void MakePositionPerfect()
	{
		...
		if (s_strGfxDeviceVersion == null)
		{
			s_strGfxDeviceVersion = SystemInfo.graphicsDeviceVersion;
		}
		if (s_strGfxDeviceVersion.Contains("Direct3D 11") || s_strGfxDeviceVersion.Contains("OpenGL"))
		{
			if (SystemSettingData.Instance != null)
			{
				if (!SystemSettingData.Instance.FixBlurryFont)
				{
		...
		else if (SystemSettingData.Instance != null)
		{
			if (!SystemSettingData.Instance.FixBlurryFont)
			{
				if (num2 % 2 == 1 && (base.pivot == Pivot.Top || base.pivot == Pivot.Center || base.pivot == Pivot.Bottom))
	...
	public override void OnFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		case Pivot.BottomRight:
			mFont.Print(processedText, color, verts, uvs, cols, mEncoding, mSymbols, UIFont.Alignment.Right, Mathf.RoundToInt(relativeSize.x * (float)mFont.size));
			break;
		default:
			mFont.Print(processedText, color, verts, uvs, cols, mEncoding, mSymbols, UIFont.Alignment.Center, Mathf.RoundToInt(relativeSize.x * (float)mFont.size));
			break;
		}
