...
public class Move : MonoBehaviour
{
	...
	internal sealed class _0024Start_002432 : GenericGenerator<WaitForSeconds>
	{
		...
		{
			internal Move _0024self__002433;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					result = (Yield(2, new WaitForSeconds(_0024self__002433.smokeDestroyTime)) ? 1 : 0);
					break;
				case 2:
					_0024self__002433.destroyEnabled = true;
					YieldDefault(1);
					goto case 1;
				case 1:
					result = 0;
		...
		internal Move _0024self__002434;

		public _0024Start_002432(Move self_)
		{
	...
	{
		return new _0024Start_002432(this).GetEnumerator();
	}
