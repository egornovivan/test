...
public class FireFade : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024Start_002429 : GenericGenerator<WaitForSeconds>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<WaitForSeconds>, IEnumerator
		{
			internal FireFade _0024self__002430;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					result = (Yield(2, new WaitForSeconds(_0024self__002430.smokeDestroyTime)) ? 1 : 0);
					break;
				case 2:
					_0024self__002430.destroyEnabled = true;
					YieldDefault(1);
					goto case 1;
				case 1:
					result = 0;
		...
		internal FireFade _0024self__002431;

		public _0024Start_002429(FireFade self_)
		{
	...
	{
		return new _0024Start_002429(this).GetEnumerator();
	}
